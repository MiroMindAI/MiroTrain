...
from torchtune.models.qwen2._component_builders import lora_qwen2
...
from ._tokenizer import QWEN3_SPECIAL_TOKENS, Qwen3Tokenizer
...
def qwen3_tokenizer_auto(
    ...
    **kwargs,
    ...
    """
    AutoTokenizer for Qwen3.

    Args:
        path (str): path to the Qwen3 model directory containing all tokenizer-related files
        max_seq_len (Optional[int]): A max sequence length to truncate tokens to.
            Default: None
        truncation_type (str): type of truncation to apply, either "left" or "right".
            Default is "right".
    ...
    Returns:
        Qwen3AutoTokenizer: Instantiation of the Qwen3 autotokenizer
    """

    return Qwen3TokenizerAuto(
        path=path,
        max_seq_len=max_seq_len,
        **kwargs,
    )
